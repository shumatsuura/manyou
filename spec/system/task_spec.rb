  ...
  describe 'タスク一覧画面' do
    ...
    context '複数のタスクを作成した場合' do
      it 'タスクが作成日時の降順に並んでいること' do
        new_task = FactoryBot.create(:task, name: 'new_task', status: '完了', priority: 1, user_id: 1)
        visit tasks_path
    ...
    #     n = 0
    #     10.times do
    #       FactoryBot.create(:task, due: current_time1 + 10.year - n.year, user_id: 1)
    #       n += 1
    #     end
    #
    #     visit tasks_path
